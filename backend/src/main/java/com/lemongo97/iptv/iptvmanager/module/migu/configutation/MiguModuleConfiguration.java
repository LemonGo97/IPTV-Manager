...
public class MiguModuleConfiguration {
    ...
    @Bean
    public MiguLiveService miguLiveService(MiguApiService miguApiService, MiguModuleProperties properties) {
        return new MiguLiveService(miguApiService, properties);
    }
}
