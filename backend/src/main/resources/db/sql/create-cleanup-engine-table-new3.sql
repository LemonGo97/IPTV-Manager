...
INSERT INTO clean_up_engine ("id", "name", "engine", "rule_type", "params", "description", "full_class_name") VALUES (7, 'HTTP 检测', 'HttpCheckEngine', 'DELAY', '[{"field":"type","label":"检测方式","options":[{"value":"GET","label":"GET"},{"value":"HEAD","label":"HEAD"}],"placeholder":null,"required":false,"type":"SELECT"},{"field":"delayMillisecond(ms)","label":"最大延迟时间","placeholder":null,"required":false,"type":"NUMBER"}]', NULL, 'com.lemongo97.iptv.iptvmanager.engine.delay.HttpCheckEngine');