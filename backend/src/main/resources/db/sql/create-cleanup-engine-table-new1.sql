...
INSERT INTO "clean_up_engine" ("id", "name", "engine", "rule_type", "params", "description", "full_class_name") VALUES (4, '大小写转换', 'CaseConversionEngine', 'NAME', '[{"field":"input","label":"输入","options":[{"value":"uppercase","label":"简体"},{"value":"lowercase","label":"繁体"}],"placeholder":null,"required":false,"type":"SELECT"},{"field":"output","label":"输出","options":[{"value":"uppercase","label":"简体"},{"value":"lowercase","label":"繁体"}],"placeholder":null,"required":false,"type":"SELECT"}]', NULL, 'com.lemongo97.iptv.iptvmanager.engine.name.CaseConversionEngine');
...
INSERT INTO "clean_up_engine" ("id", "name", "engine", "rule_type", "params", "description", "full_class_name") VALUES (7, 'HTTP 检测', 'HttpCheckEngine', 'DELAY', '[{"field":"type","label":"检测方式","options":[{"value":"GET","label":"GET"},{"value":"HEAD","label":"HEAD"}],"placeholder":null,"required":false,"type":"SELECT"},{"field":"delayMinutes","label":"最大延迟时间","placeholder":null,"required":false,"type":"NUMBER"}]', NULL, 'com.lemongo97.iptv.iptvmanager.engine.delay.HttpCheckEngine');